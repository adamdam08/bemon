...
//        jika ada kata kunci pencarian
            ...
            $reload = "order_emergency.php?pagination=true&keyword=$keyword";
            $sql =  "SELECT * FROM order_emergency WHERE id_order like '%$keyword%' or id_user like '$keyword' or id_layanan like '%$keyword%' or id_kendaraan like '%$keyword%' or status like '%$keyword%'or biaya like '%$keyword%' ORDER BY id_order";
            $result = mysql_query($sql);
        }else{
//            jika tidak ada
            $reload = "order_emergency.php?pagination=true";
            $sql =  "SELECT * FROM order_emergency ORDER BY id_order";
            $result = mysql_query($sql);
        }
...
<div class="container bdr-sv">
	<h2 class="text-left" style="margin-bottom:20px;">Layanan Emergency</h2>
