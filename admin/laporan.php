...
<div class="container-fluid">
	...
	<h2 class="text-left" style="margin-bottom:20px;">Laporan Montir</h2>
		...
		<table class="table table-condensed table-responsive table-bordered" style="background-color:white;">
			<tr>
				<th width="200"><center>Montir</center></th>
				<th width="300"><center>User</center></th>
				<th width="200"><center>Layanan</center></th>
				<th width="200"><center>Masalah</center></th>
			</tr>
			<?php
			...
			<tr>
				...
				<td><center><?php echo $dc[5];?><center></td>
