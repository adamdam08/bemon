...
//        jika ada kata kunci pencarian
            ...
            $reload = "order_konsultasi.php?pagination=true&keyword=$keyword";
            $sql =  "SELECT * FROM order_konsultasi WHERE id_order like '%$keyword%' or id_user like '$keyword' or id_layanan like '%$keyword%' or id_kendaraan like '%$keyword%' or status like '%$keyword%'or biaya like '%$keyword%'or keluhan like '%$keyword%'or id_montir like '%$keyword%' ORDER BY id_order";
            $result = mysql_query($sql);
        }else{
//            jika tidak ada
            $reload = "order_konsultasi.php?pagination=true";
            $sql =  "SELECT * FROM order_konsultasi ORDER BY id_order";
            $result = mysql_query($sql);
        }
...
<div class="container bdr-sv">
	<h2 class="text-left" style="margin-bottom:20px;">Layanan Konsultasi</h2>
	<div style="float:right;margin-top:-72px;"><?php echo paginate_one($reload, $page, $tpages); ?></div>
		<table class="table table-condensed table-responsive table-bordered" style="background-color:white;">
			<tr>
				...
				<th width="20%"><center>keluhan</center></th>
