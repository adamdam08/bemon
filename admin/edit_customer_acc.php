...
<div class="container-fluid">
    <div>
			<div class="container bdr-sv">
						...
						<div class="btn-right">
							<button type="button"  style="float:right;margin-right:10px;" oncLick="window.location.href = 'http://localhost/be-mon/admin/edit_customer_acc.php?id=<?php echo $result_acc[0];?>'" class="btn btn-primary" disabled><span class="glyphicon glyphicon-lock"></span> Edit Akun</button>
							<button type="button"  style="float:right;margin-right:10px;" oncLick="window.location.href = 'http://localhost/be-mon/admin/edit_customer.php?id=<?php echo $result_acc[0];?>'" class="btn btn-primary"><span class="glyphicon glyphicon-user"></span> Edit Biodata</button>
						</div>
						<form action="edit_customer_acc_engine.php" enctype="multipart/form-data" method="post">
						</br>
