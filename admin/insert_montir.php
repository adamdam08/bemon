...
<div class="container-fluid">
    <div>
		<form action="insert_montir_engine.php" enctype="multipart/form-data" method="post">
			<div class="container bdr-sv">
						<div>
							<h3 class="text-left">Tambah Data Montir</h3>
						</div>
						</br>
						<!-- mark -->
						<p>Nama Montir :</p>
						...
						<span class="input-group-addon">
							...
							<input type="text" class="form-control" name="no_ktp"></input>
						</div>
						</br>
						<!-- mark -->
						...
						<span class="input-group-addon">
							...
							<input type="text" class="form-control" name="no_sim"></input>	
						</div>
						</br>
						<!-- mark -->
