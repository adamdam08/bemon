...
//        jika ada kata kunci pencarian
            ...
            $reload = "order_servis_umum.php?pagination=true&keyword=$keyword";
            $sql =  "SELECT * FROM order_servis_umum WHERE id_order like '%$keyword%' or id_user like '$keyword' or id_layanan like '%$keyword%' or id_kendaraan like '%$keyword%' or status like '%$keyword%'or biaya like '%$keyword%' ORDER BY id_order";
            $result = mysql_query($sql);
        }else{
//            jika tidak ada
            $reload = "order_servis_umum.php?pagination=true";
            $sql =  "SELECT * FROM order_servis_umum ORDER BY id_order";
            $result = mysql_query($sql);
        }
...
<div class="container bdr-sv">
	<h2 class="text-left" style="margin-bottom:20px;">Layanan Servis Umum</h2>
