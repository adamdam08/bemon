...
<div class="container-fluid">
	...
	<h2 class="text-left" style="margin-bottom:20px;">Pemesanan</h2>
	<div style="float:right;margin-top:-72px;margin-right:10px;"><?php echo paginate_one($reload, $page, $tpages); ?></div>
		<table class="table table-condensed table-hover table-responsive table-bordered" style="background-color:white;">
			<tr>
				<th width="10"><center>id_booking</center></th>
				<th width="10"><center>id_jadwal</center></th>
				<th width="200"><center>email</center></th>
				<th width="200"><center>status</center></th>
				<th width="100"><center>kategori</center></th>
			</tr>
			<?php
			...
			<tr>
				<td><center><?php echo $dc['id_booking'];?></td>
				<td><center><?php echo $dc['id_jadwal'];?></td>
				<td><center><?php echo $dc['email'];?></td>
				<td><center><?php echo $dc['status'];?></td>
				<td><center><?php echo $dc['kategori'];?></center></td>
			</tr>
			<?php 
				$i++; 
				$count++;}	?>
