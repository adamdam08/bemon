...
//            jika tidak ada
            $reload = "kereta.php?pagination=true";
            $sql =  "SELECT * FROM kereta ORDER BY id_kereta";
            $result = mysql_query($sql);
        }
...
<div class="container-fluid">
	...
	<h2 class="text-left" style="margin-bottom:20px;">Data kereta</h2>
	<button type="button " style="float:right;margin-top:-52px;margin-right:10px;" onclick="window.location.href = 'http://localhost/ukk_real/admin/tambah_data_kereta.php';" class="btn btn-primary"><span class="glyphicon glyphicon-save-file"></span> Tambah Data</button>
	<div style="float:right;margin-top:-72px;margin-right:150px;"><?php echo paginate_one($reload, $page, $tpages); ?></div>
			...
			<tr>
				<th width="200"><center>Nama Kereta</center></th>
			...
			<tr>
				...
				<td><center><button type="button "onclick="window.location.href = 'http://localhost/ukk_real/admin/edit_ker.php?book=<?php echo $data[0];?>';" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-save-file"></span> Edit</button>&nbsp; <button type="button "onclick="window.location.href = 'http://localhost/ukk_real/admin/delete_kereta.php?book=<?php echo $data[0];?>&nm=<?php echo $data[1];?>';" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span> Hapus </button></center></td>
			</tr>
				<?php 
		$i++; 
        $count++;
