...
//        jika ada kata kunci pencarian
            ...
            $sql =  "SELECT * FROM jadwal_pes where id_jadwal_pes = '$keyword' ORDER BY stok_kursi asc";
            $result = mysql_query($sql);
        }else{
//            jika tidak ada
            $reload = "index2.php?pagination=true";
            $sql =  "SELECT * FROM jadwal_pes ORDER BY stok_kursi asc";
            $result = mysql_query($sql);
        }
...
<div class="container-fluid">
	<?php include 'sidebar.php';?>
		<form action="update_jadwal_pes_engine.php" enctype="multipart/form-data" method="post">
			<div class="container bdr-sv">
						<div>
							<h3 class="text-left">Edit Data Jadwal Pesawat</h3>
						</div>
						...
						<span class="input-group-addon">
							...
							<input type="text" readonly class="form-control" value="<?php echo $data['id_jadwal_pes']?>" name="id_jad"></input>	
						</div>
						...
						<span class="input-group-addon">
							...
							<input type="text" class="form-control" value="<?php echo $data['no_pesawat']?>" name="no_pes"></input>	
						</div>
						...
						<span class="input-group-addon">
							...
							<select width="20px" name ="fr_bn" class="form-control">
						...
						<span class="input-group-addon">
							...
							<?php $result = mysql_query("SELECT * FROM bandara");?>
							<select width="20px" name ="to_bn" class="form-control">
